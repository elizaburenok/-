...
export interface DropdownProps {
  ...
  /** When false, selecting an item does not call onClose (e.g. multi-select). Default: true */
  closeOnSelect?: boolean;
  /** When false, mousedown outside does not close (use a parent wrapper ref). Default: true */
...
export const Dropdown: React.FC<DropdownProps> = (props: DropdownProps) => {
  ...
  // Optional click-outside (disabled when parent wraps trigger + panel)
  useEffect(() => {
